...
class Fairy : Race {
    public Fairy() : base(
        stats: new Stats(Strength: 2, Agility: 5, Intelligence: 9),
        initialHP: 20,
...
class Orc : Race {
    public Orc() : base(
        stats: new Stats(Strength: 10, Agility: 3, Intelligence: 2),
        initialHP: 40,
...
class Alien : Race {    
    public Alien() : base(
        stats: new Stats(Strength: 2, Agility: 5, Intelligence: 10),
        initialHP: 35,
